import cartReducer, { CartState, addItem, removeItem } from "../redux/reducers/cartReducer";
...
describe("Cart Reducer", () => {
  ...
  it("should handle adding a product to the cart - addToCart", () => {
    ...
    expect(cartReducer(initialState, addItem(product))).toEqual(expectedState);
  });
  ...
  it("should handle removing a product from the cart - removeFromCart", () => {
    ...
    expect(cartReducer(initialStateWithItems, removeItem(1))).toEqual(expectedState);
  });
});
